...
export default class extends JSInterpreter {
  ...
  stepFunctionDeclaration() {
    ...
    this.setValue(
      this.createPrimitive(state.node.id.name),
  ...
  stepCallbackStatement() {
    ...
    if (
      ...
      this.stateStack[index].node.type === 'CallExpression'
    ) {
