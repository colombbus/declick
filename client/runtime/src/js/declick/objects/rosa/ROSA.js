define(['TObject'], function(TObject) {
    ...
    for (var i of ["_moveForward", "_moveBack", "_turnRight", "_turnLeft", "_rotateRight", "_rotateLeft", "_stop", "_measureDistance", "_setRSpeed", "_setLSpeed", "_obstacle", "_setMaxDist", "_setMinDist"])
