define(['jquery', 'TObject', 'TUI', 'TLink', 'SynchronousManager', 'TError'], function($, TObject, TUI, TLink, SyncMan, TError) {
    /**
...
console.log(ArduinoCreateAgentDaemon, 'loaded!!')
        ...
        if (Arduino.boardList === undefined) this._updateBoardsList();
    ...
    Arduino.prototype._declickToArduino = function(node, vars=new Map(), parentFonction=null){
        ...
        switch (node.type){
            ...
            case 'ReturnStatement':
                arduinoCode = "return(";
                arduinoCode += this._declickToArduino(node.argument, vars, parentFonction);
                arduinoCode += ")";
                break;
            ...
            case 'ExpressionStatement':
                arduinoCode = this._declickToArduino(node.expression, vars, parentFonction);
                break;
            ...
            case 'MemberExpression':
                arduinoCode = "(";
                arduinoCode += this._declickToArduino(node.object, vars, parentFonction);
                arduinoCode += ")";
                if (node.computed === true){
                    arduinoCode += "[";
                    arduinoCode += this._declickToArduino(node.property, vars, parentFonction);
                    arduinoCode += "]";
                }
                else{
                    arduinoCode += ".";
            ...
            case 'CallExpression':
                ...
                for (var arg in node.arguments) {
                    ...
                    arduinoCode += "(";
                    arduinoCode += this._declickToArduino(node.arguments[arg], vars, parentFonction);
                    arduinoCode += ")";
                }
                arduinoCode += ")";
                break;
